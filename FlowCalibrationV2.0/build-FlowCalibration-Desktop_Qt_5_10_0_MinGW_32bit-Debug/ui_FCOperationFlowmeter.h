...
public:
    ...
    void setupUi(QWidget *FCOperationFlowmeter)
    {
        if (FCOperationFlowmeter->objectName().isEmpty())
            FCOperationFlowmeter->setObjectName(QStringLiteral("FCOperationFlowmeter"));
        ...
        leCalibrationTime->setObjectName(QStringLiteral("leCalibrationTime"));
        ...
        rbConstant2->setObjectName(QStringLiteral("rbConstant2"));
        ...
        rbConstant3->setObjectName(QStringLiteral("rbConstant3"));
        ...
        rbConstant1->setObjectName(QStringLiteral("rbConstant1"));
        ...
        tbnWriteConst->setObjectName(QStringLiteral("tbnWriteConst"));

        gridLayout_30->addWidget(tbnWriteConst, 1, 2, 1, 1);

        tbnCalculateConst = new QToolButton(layoutWidget_5);
        tbnCalculateConst->setObjectName(QStringLiteral("tbnCalculateConst"));
