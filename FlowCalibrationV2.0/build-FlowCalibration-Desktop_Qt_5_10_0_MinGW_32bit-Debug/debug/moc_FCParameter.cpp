...
void FCParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FCParameter *_t = static_cast<FCParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (FCParameter::*_t)(QString , uint16_t );
        ...
        {
            typedef void (FCParameter::*_t)(QVector<float> );
        ...
        {
            typedef void (FCParameter::*_t)(QString );
...
const QMetaObject FCParameter::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FCParameter.data,
      qt_meta_data_FCParameter,  qt_static_metacall, nullptr, nullptr}
};
