...
void FCRecordEvent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FCRecordEvent *_t = static_cast<FCRecordEvent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (FCRecordEvent::*_t)(QString , uint16_t );
...
const QMetaObject FCRecordEvent::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FCRecordEvent.data,
      qt_meta_data_FCRecordEvent,  qt_static_metacall, nullptr, nullptr}
};
