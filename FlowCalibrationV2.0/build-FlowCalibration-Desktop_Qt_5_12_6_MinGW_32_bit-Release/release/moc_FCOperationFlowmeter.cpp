...
void FCOperationFlowmeter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FCOperationFlowmeter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FCOperationFlowmeter::*)(QString , uint16_t );
        ...
        {
            using _t = void (FCOperationFlowmeter::*)(QString , QString );
        ...
        {
            using _t = void (FCOperationFlowmeter::*)();
        ...
        {
            using _t = void (FCOperationFlowmeter::*)(QVector<float> );
...
QT_INIT_METAOBJECT const QMetaObject FCOperationFlowmeter::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_FCOperationFlowmeter.data,
    qt_meta_data_FCOperationFlowmeter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
